...
const Tags = () => {
  const tagsList = [{
    id: 1,
    tagName: "javascript",
    tagDesc: "For questions regarding programming in ECMAScript (JavaScript/JS) and its various dialects/implementations (excluding ActionScript). Please include all the relevant tags on your question."
  },{
    id: 2,
    tagName: "python",
    ...
    id: 3,
    tagName: "c#",
    tagDesc: "C# (prounounced 'see sharp' is a high level, statically typed, multi-paradigm programming language developed by Microsoft.",
  },{
    id: 4,
    tagName: "java",
